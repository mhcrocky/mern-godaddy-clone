    ...
    <div className="p-8 w-full block">
      <div className="grid grid-cols-3 " >
        <div className="col-span-3 lg:col-span-3 xl:col-span-2 mb-5" >
          <div className="h-full px-10  rounded-md grid-cols-2 mr-0 lg:mr-0 xl:mr-3" style={{
            ...
            <div className="py-20">
              ...
              <h1 className="text-5xl font-black py-2">Tools for all your Businesses first</h1>
